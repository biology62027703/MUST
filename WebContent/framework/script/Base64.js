/**
 * @fileoverview 定義處理 Base64 編碼的&#x5171;用函式
 *
 * @author Welkin Fan
 * @version 1.0
 */
...
Base64.encode=function(str)
{
	...
	{
		throw new Error(getExceptionStr("Base64.encode",arguments,ex));
	}
}
...
Base64.decode=function(str)
{
	...
	{
		throw new Error(getExceptionStr("Base64.decode",arguments,ex));
	}
}