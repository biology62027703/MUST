...
public class ExtRandomAccessFile {
	...
	public long readLong() throws IOException {
		byte[] b = new byte[8];
		file.read(b, 0, 8);
		long out = de.idyl.crypto.zip.impl.ByteArrayHelper.toLong(b);
		return out;
	}
	...
	public int readInt() throws IOException {
		byte[] b = new byte[4];
		file.read(b, 0, 4);
		int out = de.idyl.crypto.zip.impl.ByteArrayHelper.toInt(b);
		return out;
	}
	...
	public short readShort() throws IOException {
		byte[] b = new byte[2];
		file.read(b, 0, 2);
		short out = de.idyl.crypto.zip.impl.ByteArrayHelper.toShort(b);
		return out;
	}
