...
public class AUnzip {
	String zipFromString = ""; //要從那個壓縮檔解壓縮
	String zipToString = "./"; //要解壓縮到那個目錄
	Enumeration entries;
	utility ut = new utility();
	static String os = checkOS();
	ZipFile zipFile;
	boolean containDir = false; //是否包含路徑
	private boolean isDecrypt = false;	//解密
	private String passwd = ""; 

	/**
	 * 必需有apache ant 的 org.apache.tools.zip 套件。
	 * 建構子 例子: AUnzip z = new AUnzip(); z.UnzipFrom("c:\\ddd.zip"); z.UnzipTo("d:\\safe");
	 * z.write();
	 */
	 ...
	 *            解壓縮時是否包含原本的路徑資料
	 */
	public AUnzip(boolean containDir) {
