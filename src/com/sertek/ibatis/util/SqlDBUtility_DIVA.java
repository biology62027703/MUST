...
public class SqlDBUtility_DIVA extends SqlMapClientTemplate {
	...
	/**
	 * �ϥνd�� String sql ="select a.crmyy,a.crmid,a.CRMNO,a.rsn,b.address from
	 ...
	 * (Map)list.next(); //���X�Ӫ����W�٦����j�p�g�A�̸�Ʈw�إߪ��j�p�g����
	...
	/**
	 * resultClass�Ojava.util.LinkedHashMap
	 * @param sql
	 * @return
	 * @throws DataAccessException
	 */
