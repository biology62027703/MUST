...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapSearchBase = "dc=must,dc=org,dc=tw";        
        ...
        //env.put("com.sun.jndi.ldap.trace.ber", System.err.toString());
        ...
        SearchResult srLdapUser = ldap.findAccountByAccountName(ctx, ldapSearchBase,  account);
    ...
    public String getPrimaryGroupSID(SearchResult srLdapUser) throws NamingException {
        ...
        System.out.println("*****"+strPrimaryGroupID);
        String strObjectSid = decodeSID(objectSID);
        //System.out.println("------*****"+strObjectSid.substring(0, strObjectSid.lastIndexOf('-') + 1) + strPrimaryGroupID);
